<template>
  <div class="app-container">
    <el-form ref="form" v-model="form" label-width="120px">
      ...
      <el-form-item label="权限申请" prop="userPrivileges">
        <!-- <el-select v-model="this.form.region" placeholder="请选择您要申请的权限"> -->
        <el-select v-model="form.userPrivileges">
  ...
  created() {
    this.$store.dispatch('user/getInfo')
      .then((res) => {
        ...
        this.form.institutionType = res.userId
